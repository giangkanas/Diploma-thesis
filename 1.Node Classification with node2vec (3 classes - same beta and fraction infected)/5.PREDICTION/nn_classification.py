...
def HyperBand(filename):
    ...
    """CollegeMsg =>best batch size = 64 """
    """Facebook =>best batch size = 128 """
    """WikiVotes =>best batch size = 512 """
    
def baseline_model1():
    """ ΜΟΝΤΕΛΟ ΠΟΥ ΠΡΟΕΚΥΨΕ ΑΠΟ HYPERBAND """
    model = Sequential([
        Dense(248, input_dim = 64, activation='relu'),
...
def baseline_model2():
    """ ΜΟΝΤΕΛΟ ΠΟΥ ΠΡΟΕΚΥΨΕ ΑΠΟ HYPERBAND """
    model = Sequential([
        Dense(160, input_dim = 256, activation='relu'),
...
def baseline_model3():
    """ ΜΟΝΤΕΛΟ ΠΟΥ ΠΡΟΕΚΥΨΕ ΑΠΟ HYPERBAND """
    model = Sequential([
        Dense(176, input_dim = 256, activation='relu'),
...
def crossValidation(filename):
    ...
    """Facebook =>best batch size = 128 """
    """WikiVotes =>best batch size = 512 """
    estimator = KerasClassifier(build_fn=baseline_model2, epochs=50, batch_size=128, verbose=1 )
